...
export default class WebClient extends EventEmitter {
  activate(options) {
    ...
    this.staticFolderPath = options.staticFolderPath || path.join(__dirname, "../../../", "./client");
    ...
    this.jspmConfigPath = this.jspmConfigPath || path.join(this.jspmPath, "./jspm.config.js");
