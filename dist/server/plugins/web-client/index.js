...
class WebClient extends _events.EventEmitter {
  activate(options) {
    options = options || {};
    ...
    this.rootPath = options.rootPath || "/web";
    this.playerSourcePath = options.playerSourcePath || "/";
    this.staticFolderPath = options.staticFolderPath || _path2.default.join(__dirname, "../../../", "./client");
    ...
    this.jspmConfigPath = this.jspmConfigPath || _path2.default.join(this.jspmPath, "./jspm.config.js");
    ...
    this.app.get("/jspm.config.js", (req, res) => res.sendFile(fixWindowsPath(this.jspmConfigPath)));
